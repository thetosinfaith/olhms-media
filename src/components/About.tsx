        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12 items-center">
          ...
          <div className="p-4 md:p-8 flex flex-col justify-center text-left">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-400 to-zinc-500">
                Tosin Olomu.
              </span>
            </h2>

            <p
              className="text-base md:text-lg mb-8 leading-normal text-gray-300 font-light max-w-2xl mx-auto lg:mx-0
                animate-fade-in-up delay-400"
            >
              Hi! I’m Tosin, but you can call me Tee. Growing up, my dad’s
              camcorder captured so many random moments that are now etched in
              my heart forever.
              <br />
              <br />
              My phone and I are inseparable. When I see a moment, my first
              instinct is always to capture it. Moments are precious, and while
              we can't time travel, we can capture them in real-time and keep
              them forever!
              <br />
              <br />
              ...
              and a crazy{" "}
              <strong className="text-neon-purple font-black text-xl">
                32 Million+ Views
              </strong>
              . Guess I'm not the only one obsessed with crafting epic visuals!
            </p>

            <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-8 mt-10 animate-fade-in-up delay-600"></div>
          </div>
        </div>
      </div>
    </section>
